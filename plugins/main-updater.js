...
cmd({  
  ...
  try {  
    ...
    const { data: commitData } = await axios.get("https://api.github.com/repos/MRSHABAN40/SK37/commits/main");  
    ...
    const { data: zipData } = await axios.get("https://github.com/MRSHABAN40/SK37/archive/main.zip", { responseType: "arraybuffer" });  
    ...
    const sourcePath = path.join(extractPath, "SK37-main");  
